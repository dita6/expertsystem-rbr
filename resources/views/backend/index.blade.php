...
<head>
    ...
    <!-- Website Title -->
    <title>Dashboard | Sistem Pakar Rule Based Reasoning</title>
    <!-- Favicon Website -->
    <link href="{{ asset('backend/assets/img/logo.png')}}" alt="logo" rel="icon" />
    <!-- CSS -->
    ...
    <!-- jQuery idle -->
    <script type="text/javascript" src="{{ asset('backend/assets/js/jquery.idle.js')}}"></script>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">SistemPakar.</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('backend/dist/img/pp.png')}}" class="img-circle elevation-2" alt="User Image">
