        ...
        <div class="card">
            <div class="card-header">
                <div class="float-right">
                    <a href="{{route('gejala.create')}}" class="btn btn-primary btn-sm">Tambah Data</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($data as $dl)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/gejala/edit', $dl->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                    
                                    <a class="btn btn-danger btn-sm" href="{{route('gejala.destroy',$dl->id)}}"
