        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <form action="{{ route('rule.store') }}" method="POST" class="form-horizontal"
                        enctype="multipart/form-data">
                        @csrf

                        <div class="form-group">
                            <label>Kode Rule</label>
                            <input type="text" class="form-control" name="kode_rule" id="kode_rule" readonly value="{{ isset($kode_rule) ? $kode_rule : '' }}">
                            @error('kode_rule')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="ks" id="ks">
                                @foreach ( $ks as $item )
